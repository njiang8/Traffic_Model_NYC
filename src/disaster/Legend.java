...
public class Legend extends Canvas {
    ...
    public void paint(Graphics legend)
    {
        ...
        // buildings grouping
	        ...
	        leg.setColor(bldg);       
	        leg.fillRect(25, s3,     20, 20);  //430
	        leg.setColor(home);       
	        leg.fillRect(25, s3+30,  20, 20);  //470        
	        leg.setColor(work);       
	        leg.fillRect(25, s3+60,  20, 20);  //510
	        leg.setColor(school);       
	        leg.fillRect(25, s3+90,  20, 20);  //550
	        leg.setColor(dCare);       
	        leg.fillRect(25, s3+120, 20, 20);  //590
	        
	        // labels
	        int l3 = s3+15; 			// plot height for labels
	        leg.setFont(f3);         
	        leg.setColor(Color.black);      
	        leg.drawString("Office",   70, l3);
	        leg.drawString("Home",     70, l3+30);
	        leg.drawString("Work",     70, l3+60);
	        leg.drawString("School",   70, l3+90);
	        leg.drawString("Day Care", 70, l3+120);
